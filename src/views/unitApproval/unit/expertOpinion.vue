      ...
      <div slot="body">
        <div>
          <el-form :inline="true" :rules="rules" ref="ruleForm" :model="form" class="demo-form-inline" label-width='100px' label-position='top'>
            <el-form-item label="专家鉴定意见" prop="content">
...
export default {
  ...
  created() {
    this.getData().then((data) => {
      ...
      this.form.content = data.expertOpinion
    })
  },
      ...
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          this.getData().then((res) => {
            if (res) {
              res.expertOpinion = this.form.content
              ...
              this.data.expertOpinion = this.form.content
